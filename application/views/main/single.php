					...
					<ul class="navbar-nav ml-auto pl-lg-5 pl-0">
						...
						<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
							...
							<div class="dropdown-menu" aria-labelledby="dropdown04">
								...
								<a class="dropdown-item" href="services.html">Enjoy Drinks</a> <a
									class="dropdown-item" href="services.html">Eat All You Can</a>
							</div></li>
						<li class="nav-item"><a class="nav-link " href="about.html">About</a>
						</li>
						<li class="nav-item"><a class="nav-link active" href="news.html">News</a>
						</li>
				...
				<div
					...
					<div class="col-md-8 text-center col-sm-12 ">
						<p class="mb-2" data-aos="fade-up">
							May 2, 2019 <span class="mx-3">&bullet;</span> Posted by <a
								href="#" target="_blank">Admin</a>
						</p>
						<h1 data-aos="fade-up" data-aos-delay="100">How To Bake A Good
							Taste Food</h1>
			...
			<div class="row">
				<div class="col-lg-8 blog-content">
					...
					<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing
						elit. Assumenda nihil aspernatur nemo sunt, qui, harum repudiandae
						quisquam eaque dolore itaque quod tenetur quo quos labore?</p>
					<p>
						<img src="img/dishes_1.jpg" alt="Image" class="img-fluid rounded">
					</p>
					...
					<p>Eveniet deleniti accusantium nulla natus nobis nam asperiores
						ipsa minima laudantium vero cumque cupiditate ipsum ratione dicta,
					...
					<p>Consectetur porro odio quod iure quaerat cupiditate similique,
					...
					<p>Id similique, rem ipsam accusantium iusto dolores sit velit ex
